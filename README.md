...
себя трассу с машиной, управляемой нейронной сетью. Награды реализованы с помощью ревард-чекпоинтов, расставленных
по трассе, также награды выдаются за движение в их направлении.
